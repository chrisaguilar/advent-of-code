...
async function main() {
    try {
        const input = (await readFile(resolve(__dirname, '02.txt'), 'utf8')).trim();
        /*
        ...
        */
        ...
        console.time('Day 02: I Was Told There Would Be No Math Part One');

        const surfaceArea = (l, w, h) => 2 * (l * w + h * w + h * l);
        const part1 =
            input.split('\n')
                .map(e => e.split('x').map(Number).sort((a, b) => a - b))
                .reduce((a, b) => a + (b[0] * b[1] + surfaceArea(...b)), 0);

        console.timeEnd('Day 02: I Was Told There Would Be No Math Part One');
        ...
        */
        ...
        console.time('Day 02: I Was Told There Would Be No Math Part Two');



        console.timeEnd('Day 02: I Was Told There Would Be No Math Part Two');
    } catch (e) {
        console.error(e);
    }
}
